...
#define SHOOTER_RESET_SPEED -0.1
//angle/speed matrix

#define SHOT_HIGH_ANGLE 70.0
#define SHOT_HIGH_SPEED 0.9

#define SHOT_LOW_ANGLE 50.0
#define SHOT_LOW_SPEED 0.6

#define SHOT_TRUSS_ANGLE 45.0
#define SHOT_TRUSS_SPEED 1.0

#define SHOT_PASS_ANGLE 60.0
#define SHOT_PASS_SPEED 0.4

#define SHOT_TEST_ANGLE 70.0
#define SHOT_TEST_SPEED 1.0
