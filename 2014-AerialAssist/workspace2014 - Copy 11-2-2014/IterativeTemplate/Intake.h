...
#define INTAKE_EXTEND_POWER 1.0
#define INTAKE_RETRACT_POWER -1.0


#define INTAKE_ROLLER_DIRECTION 1.0
#define INTAKE_EXTENDER_DIRECTION -1.0     // THIS MUST BE -1.0 ("NEGATIVE ONE")
...
#define EXTENDER_P 2.0
#define EXTENDER_I 0.0
#define EXTENDER_D 0.0
#define EXTENDER_PERIOD 0.05
#define EXTENDER_MAX_DISTANCE 16.0
#define EXTENDER_MIN_SPEED -1.0
#define EXTENDER_MAX_SPEED 1.0

#define EXTENDER_SPEED_STOP 0.0

//for PID controller
#define FULL_EXTEND_DISTANCE 14.0
#define FULL_RETRACT_DISTANCE 1.0
