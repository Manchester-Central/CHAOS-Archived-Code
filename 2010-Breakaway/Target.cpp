...
double Target::Get_m_majorRadius()
{
...
{
	/*
	m_majorRadius values for 5 foot intervals: Trial 1
	25	0.055521
	20	0.070476
	15	0.093038
	10	0.137448
	...
	y = 533.93x2 - 282.91x + 37.951
	*******************************
	25	0.078387
	20	0.098025
	15	0.128536
	11	0.174578 // can't see full target through door
	5	0.379235

	y = 397.06x2 - 245.07x + 40.887
    */
	
	double x = m_majorRadius;
	//double Distance = (533.93 * (x * x)) - (282.91 * (x)) + 37.951;
	double Distance = (397.06 * (x * x)) - (245.07 * (x)) + 40.887; 
